    ...
    <main className="ops">
      <header>
        <div>
          ...
          <span>Legacy · crawl chính = Payload Admin → Crawl Jobs</span>
        </div>
        <div className="actions">
          <Link href="/map">← Bản đồ</Link>
          <Link href="/admin/collections/crawl-jobs">Crawl Jobs</Link>
      ...
      <div className="banner">
        Đường chính để chạy crawl: tạo job trong{' '}
        <Link href="/admin/collections/crawl-jobs">Payload Admin → Crawl Jobs</Link>. Trang Ops
        giữ metrics/export phụ.
      </div>
